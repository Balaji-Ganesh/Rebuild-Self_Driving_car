...
code adopted from: https://github.com/tizianofiorenzani/how_do_drones_work/blob/master/opencv/cameracalib.py
understand the flow of the code from: https://docs.opencv.org/4.x/dc/dbb/tutorial_py_calibration.html
question: how to use this calibrated matrix?
"""
...
workingFolder = "./captured_checkerboards"
imageType = 'png'
# ------------------------------------------
